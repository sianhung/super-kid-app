...
public class MainActivity extends AppCompatActivity {
    ...
    String mainURL = "https://sianhung-superkid.surge.sh/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(unifiedPushEndpointReceiver, new IntentFilter("com.superkid.webtoapk.NEW_ENDPOINT"), RECEIVER_NOT_EXPORTED);
        } else {
            registerReceiver(unifiedPushEndpointReceiver, new IntentFilter("com.superkid.webtoapk.NEW_ENDPOINT"));
        }
